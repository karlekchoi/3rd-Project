...
export const MugunghwaIcon = ({ isBookmarked = false }: { isBookmarked?: boolean }) => {
  const iconColor = isBookmarked ? '#D72638' : '#9CA3AF';
  const fillColor = isBookmarked ? iconColor : 'none';
